...
export const classRoutes = async (app) => {
    app.post("/api/classes", { preHandler: [requireAuth] }, async (request, reply) => {
    ...
    app.post("/api/classes/join", { preHandler: [requireAuth] }, async (request, reply) => {
    ...
    app.get("/api/classes/:id", { preHandler: [requireAuth] }, async (request, reply) => {
    ...
    app.get("/api/classes/:id/students", { preHandler: [requireAuth] }, async (request, reply) => {
        const { id } = request.params;
        const targetClass = await prisma.class.findUnique({
            where: { id, teacherId: request.user.id },
        });
    ...
    app.delete("/api/classes/:id", { preHandler: [requireAuth] }, async (request, reply) => {
        const { id } = request.params;
        const targetClass = await prisma.class.findUnique({
            where: { id },
        });
